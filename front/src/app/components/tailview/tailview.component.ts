...
export class TailViewComponent implements OnInit, OnDestroy, AfterViewChecked {
    ...
    constructor(private eventSourceService : EventSourceService, private httpCallsService : HttpCallsService, private messageService: MessageService) {}
    
    ngOnInit() {

       
       this.httpCallsService.connect(this.connection).subscribe(
               data =>{                        
